...
pub fn create_fixed_strategy_contract<'a>(e: &Env, asset: &Address, apr_bps: u32, token_admin_client: &StellarAssetClient) -> FixedStrategyClient<'a> {
    ...
    token_admin_client.mock_all_auths().mint(&client.address, &starting_amount);
