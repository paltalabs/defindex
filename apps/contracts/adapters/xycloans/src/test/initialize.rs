...
fn test_initialize_twice() {
    ...
    let result_second_init = test.adapter_contract.try_initialize(&test.router_contract.address, &test.xycloans_pool.address, &test.token_0.address, &test.token_1.address);
    assert_eq!(
        result_second_init,
