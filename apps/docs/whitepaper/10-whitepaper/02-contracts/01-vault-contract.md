...
Let’s denote the total supply at time 0 as $s_0$ and the total managed funds as $v\_0$. At time 1, a user wants to deposit an additional amount $v'$, and new shares $s'$ are minted. The value of any share $val(s)$ at time $t$ is calculated as:
