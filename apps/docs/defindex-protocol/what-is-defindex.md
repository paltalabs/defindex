...
* For example, if fees are 50%, and a user earns 10 USDC on a strategy, 5 USDC will go to the user, 2.5 USDC will go to the Vault manager and 2.5 USDC will go to DeFindex.
