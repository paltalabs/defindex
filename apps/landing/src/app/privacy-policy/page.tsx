...
export default function PrivacyPolicy(){
  return (
    <div className="min-h-screen bg-black relative z-0">
      ...
      />
      <Navbar/>
      <main className="container mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        <div className="bg-cyan-950/30 backdrop-blur-sm border border-cyan-800/30 rounded-2xl p-8 sm:p-12">
          <header className="mb-12">
            <h1 className="font-manrope font-bold text-3xl sm:text-4xl lg:text-5xl text-white mb-4">
          ...
          <div className="space-y-8 text-white">
            <section>
              <h2 className="font-manrope font-bold text-xl sm:text-2xl text-lime-200 mb-4">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-manrope font-semibold text-lg text-white mb-3">a) Blockchain Data</h3>
                  <p className="text-gray-200 font-inter leading-relaxed">
                ...
                <div>
                  <h3 className="font-manrope font-semibold text-lg text-white mb-3">b) Technical Data</h3>
                  <p className="text-gray-200 font-inter leading-relaxed mb-3">
                    When you visit the Site, we may automatically collect certain technical information such as:
                  </p>
                  <ul className="list-disc list-inside text-gray-200 font-inter leading-relaxed space-y-1 ml-4">
                    <li>IP address</li>
                ...
                <div>
                  <h3 className="font-manrope font-semibold text-lg text-white mb-3">c) Cookies</h3>
                  <p className="text-gray-200 font-inter leading-relaxed">
                ...
                <div>
                  <h3 className="font-manrope font-semibold text-lg text-white mb-3">d) Aggregate Data</h3>
                  <p className="text-gray-200 font-inter leading-relaxed">
                ...
                <div>
                  <h3 className="font-manrope font-semibold text-lg text-white mb-3">e) Social Networks</h3>
                  <p className="text-gray-200 font-inter leading-relaxed">
            ...
            <section>
              ...
              <div className="text-gray-200 font-inter leading-relaxed space-y-3">
                ...
                <p>We do not track or store blockchain transaction data.</p>
              </div>
            </section>
            ...
            <footer className="border-t border-cyan-800/30 pt-8 mt-12">
              <p className="text-gray-300 font-inter text-sm text-center">
                Last Updated: September 12, 2025
              </p>
            </footer>
          </div>
