...
export default function OurTeam() {
    return (
        <section id="built-by-palta-labs" className="py-10 px-4 md:px-8 lg:px-16 overflow-hidden w-full">
            <div className="max-w-full mx-auto w-full" style={{maxWidth: CONTAINER_MAX_WIDTH}}>
                <div className="rounded-3xl p-6 sm:p-8 md:p-16 text-center bg-[#DEC9F4]">
                    ...
                    <CTAButton
                        ...
                        className="mx-[auto] min-w-[200px] max-w-[300px] px-8 text-[11px] sm:text-sm"
                    >
