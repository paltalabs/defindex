            ...
            <div className="container">
                <div className="max-w-[1056px] mx-auto py-10 md:py-16 px-6 sm:px-10 md:px-[85px] rounded-3xl bg-[linear-gradient(115deg,_#033036_16.31%,_#06383D_81.67%)] backdrop-blur-[29px]">
                    <h2
                        ...
                        className="text-linear italic mb-6 bg-linear font-bold font-familjen-grotesk text-center text-[36px] sm:text-[40px] leading-none lg:text-xl tracking-[-0.03em]"
                    >
                        Explore How DeFindex Can Elevate Your Wallet Experience
                    </h2>
                    <p
                        data-aos="fade-zoom-in"
                        className="mb-8 font-inter-tight text-center text-[18px] sm:text-[20px] lg:text-lg leading-normal text-white"
                    >
                    ...
                    <div
                        data-aos="fade-zoom-in"
                        className="flex sm:flex-row flex-col justify-center gap-2 sm:gap-4"
                    >
                        <Link
