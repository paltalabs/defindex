...
function HowWorks() {
    return (
        <section
            id="how-it-works"
            className="mb-16 sm:mb-20 md:mb-24 lg:mb-28 xl:mb-32 overflow-hidden"
        >
            <div className="container">
                <div className="max-w-[1216px] mx-auto">
                    <div className="flex gap-2 md:gap-4 sm:items-center flex-col mb-7 sm:mb-10 md:mb-16 lg:mb-20">
                        <p
                            data-aos="fade-up"
                            className="font-familjen-grotesk uppercase text-left sm:text-center text-[18px] sm:text-[20px] md:text-[22px] lg:text-lg leading-[1.42em] tracking-[-0.03em] text-uppercase text-blue-100"
                        >
                            How It Works
                        </p>
                        <h2
                            data-aos="fade-up"
                            className="font-bold font-familjen-grotesk leading-[1.11em] text-[48px] sm:text-[56px] md:text-[64px] lg:text-3xl tracking-[-0.03em] text-linear bg-linear"
                        >
                            How DeFindex Works
                        </h2>
                    </div>
                        ...
                        <div className="flex-grow">
                            ...
                            <div className="lg:max-w-[505px]">
                                <p
                                    data-aos="fade-right"
                                    data-aos-offset="100"
                                    className="font-semibold font-inter-tight leading-[1.315em] text-[16px] sm:text-[20px] md:text-lg text-blue-100 mb-6"
                                >
                                ...
                                <p
                                    data-aos-offset="50"
                                    data-aos="fade-right"
                                    className="font-inter-tight text-[16px] sm:text-[20px] md:text-lg text-blue-100"
                                >
