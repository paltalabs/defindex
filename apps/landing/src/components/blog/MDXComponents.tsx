 ...
 * Each heading level uses a different gradient variant for visual hierarchy
 * Hierarchy: Title (24px) > H2 (20px) > H3 (18px) > Paragraph (16px) on desktop
 */
...
/**
 * Custom paragraph component with proper spacing and typography
 */
 ...
 * Uses the existing react-syntax-highlighter with design system colors
 */
interface CodeProps {
  inline?: boolean;
  className?: string;
...
const CustomCode = ({ inline, className, children, ...props }: CodeProps) => {
  ...
  // Using CodeBlock component that only renders on client-side
  return (
 ...
 * Automatically converts to WebP/AVIF and lazy loads
 */
...
/**
 * Custom link component with proper styling and external link handling
...
/**
 * Custom blockquote component with design system styling
 */
...
/**
 * Custom table components with design system styling
 */
 ...
 * These components will replace the default HTML elements in MDX content
 */
